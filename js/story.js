(function($) {
    ...
    app = {
        ...
        data: {
            files: [
                'img/story/africa_smith.png',
                'img/story/anna.png',
                'img/story/bg_top_2.jpg',
                'img/story/bg_top.jpg',
                'img/story/bg.jpg',
                'img/story/blade.png',
                'img/story/doctor.png',
                'img/story/firestar.png',
                'img/story/gorilla_hand.png',
                'img/story/lightning-1.png',
                'img/story/lightning-2.png',
                'img/story/lou.png',
                'img/story/mask.png',
                'img/story/Q.png',
                'img/story/robot_hand.png',
                'img/story/smith.png',
                'img/story/tool.png',
            ],
            loaded: [],
        ...
        fire(){
            ...
            img = new Image();
            img.src= 'img/story/firestar.png';
